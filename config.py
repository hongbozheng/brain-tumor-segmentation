...
""" SGD """
_C.MODEL.UNETR.LR = 1e-4  # 3e-4
_C.MODEL.UNETR.MOMENTUM = 3e-5
_C.MODEL.UNETR.WEIGHT_DECAY = 0.99
_C.MODEL.UNETR.NESTEROV = True
_C.MODEL.UNETR.POWER = 0.9
...
""" SGD """
_C.MODEL.UNETR_PP.LR = 1e-4  # 3e-4
...
""" AdamW """
'''
_C.MODEL.UNETR_PP.LR = 1e-4
_C.MODEL.UNETR_PP.WEIGHT_DECAY = 1e-5
'''
...
""" SGD """
_C.MODEL.NNFORMER.LR = 1e-4  # 1e-2
...
""" DataLoader """
_C.LOADER.NUM_WORKERS_TRAIN = 8
_C.LOADER.NUM_WORKERS_VAL = 8
